...
public class RoleController {
    ...
    @CacheData(cacheKey = Constant.ROLE_CACHE,dataClass = PageResult.class,expireTime = 7L,timeUnit = TimeUnit.DAYS)
    @PostMapping("/lists")
    @ResponseBody
    public PageResult rolesSplit(@RequestParam("page")Integer currentPage, @RequestParam("limit")Integer limit, String search){
        try {
