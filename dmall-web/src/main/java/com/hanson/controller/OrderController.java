...
public class OrderController {
    ...
    @PostMapping("/lists")
    @ResponseBody
    public PageResult<List<OrderTable>> orderSplit(@RequestParam("limit") Integer limit, @RequestParam("page") Integer page, String search){
        try {
    ...
    @ResponseBody
    public PageResult<List<OrderTable>> orderBinSplit(@RequestParam("limit") Integer limit, @RequestParam("page") Integer page, String search){
        try {
