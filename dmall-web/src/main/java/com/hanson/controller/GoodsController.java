...
import com.hanson.pojo.dto.PageInfo;
...
public class GoodsController {
    ...
    @CacheData(cacheKey = Constant.GOODS_CACHE,dataClass = PageResult.class,expireTime = 7L,timeUnit = TimeUnit.DAYS)
    @PostMapping("/lists")
    @ResponseBody
    public PageResult goodsSplit(@RequestParam("limit") Integer pageSize, @RequestParam("page") Integer currentPage, String search){
    ...
    */
    ...
    @CacheClear(keys = {Constant.GOODS_CACHE})
    @PostMapping("/edit")
    @ResponseBody
