...
public class LogisticsController {
    ...
    @CacheData(cacheKey = Constant.LOGISTICS_CACHE,dataClass = PageResult.class,expireTime = 7L,timeUnit = TimeUnit.DAYS)
    @PostMapping("/lists")
    @ResponseBody
    public PageResult logisticsSplit(@RequestParam("page") Integer page, @RequestParam("limit")Integer limit, String search){
        try {
    ...
    @CacheClear(keys = {Constant.LOGISTICS_CACHE})
    @PostMapping("/add")
    @ResponseBody
