 ...
 */
    ...
    @CacheData(cacheKey = Constant.ADMIN_CACHE,dataClass = PageResult.class,expireTime = 7L,timeUnit = TimeUnit.DAYS)
    @PostMapping("/lists")
    @ResponseBody
    public PageResult adminSplit(@RequestParam("limit") Integer limit, @RequestParam("page") Integer page, String search){
        try {
...
*/
    ...
    @CacheClear(keys = {Constant.ADMIN_CACHE})
    @PostMapping("/on")
    @ResponseBody
