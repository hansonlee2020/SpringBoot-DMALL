...
public class MemberController {
    ...
    @CacheData(cacheKey = Constant.MEMBER_CACHE,dataClass = PageResult.class,expireTime = 7L,timeUnit = TimeUnit.DAYS)
    @PostMapping("/lists")
    @ResponseBody
    public PageResult memberSplit(@RequestParam("limit") Integer limit, @RequestParam("page") Integer page, String search){
    ...
    @CacheClear(keys = {Constant.MEMBER_CACHE,Constant.MEMBERTRASH_CACHE})
    @PostMapping("/on")
    @ResponseBody
    ...
    @CacheData(cacheKey = Constant.MEMBERTRASH_CACHE,dataClass = PageResult.class,expireTime = 7L,timeUnit = TimeUnit.DAYS)
    @PostMapping("/recycle/bin")
    @ResponseBody
    public PageResult memberBinSplit(@RequestParam("limit") Integer limit, @RequestParam("page") Integer page, String search){
        try {
