...
public interface Constant {
    ...
    --------------------项目配置环境--------------------
     */
    String ENVIROMENT_PRO = "pro";
    String ENVIROMENT_DEV = "dev";
    String ENVIROMENT_TEST = "test";

    /*
    --------------------删除标志--------------------------
     */
    Integer DELETE_FLAG_OPEN = 1;
    Integer DELETE_FLAG_CLOSE = 0;
    ...
    String MEMBER_CACHE = "MEMBER:CACHE";
    String MEMBERTRASH_CACHE = "MEMBERTRASH:CACHE";
    String WEBLOG_CACHE = "WEBLOG:CACHE";
    String AUTHORITY_GROUP_CACHE = "AUTHORITYGROUP:CACHE";
    String AUTHORITY_CACHE = "AUTHORITY:CACHE";
    String GOODS_CACHE = "GOODS:CACHE";
    String LOGISTICS_CACHE = "LOGISTICS:CACHE";
    String ORDER_CACHE = "ORDER:CACHE";
    String ORDERTRASH_CACHE = "ORDERTRASH:CACHE";
    String ROLE_CACHE = "ROLE:CACHE";
}
